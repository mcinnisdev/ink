...
hero_code: |
  <span class="prompt">$</span> npx inksite init my-site
  ...
  <span class="prompt">$</span> cd my-site && npx inksite add contact-form
...
how_it_works:
  ...
  steps:
    - title: "Scaffold"
      description: "Run npx inksite init to generate a complete project with content types, design tokens, layouts, and a dev server. You get a working site in under a minute."
    - title: "Write"
...
code_examples:
  ...
  tabs:
    ...
    - label: "CLI Usage"
      content: "<pre><code><span class=\"token comment\"># Scaffold a new project</span>\n<span class=\"token function\">$</span> npx inksite init <span class=\"token variable\">my-site</span>\n\n<span class=\"token comment\"># Add a content type</span>\n<span class=\"token function\">$</span> npx inksite generate <span class=\"token variable\">blog</span>\n\n<span class=\"token comment\"># Install a component</span>\n<span class=\"token function\">$</span> npx inksite add <span class=\"token variable\">pricing-table</span>\n\n<span class=\"token comment\"># List available components</span>\n<span class=\"token function\">$</span> npx inksite list <span class=\"token variable\">components</span>\n\n<span class=\"token comment\"># Start the dev server</span>\n<span class=\"token function\">$</span> npx inksite <span class=\"token variable\">serve</span>\n\n<span class=\"token comment\"># Build for production</span>\n<span class=\"token function\">$</span> npx inksite <span class=\"token variable\">build</span></code></pre>"
stats:
  - value: 0
    suffix: ""
